...
def get_bandit(args) -> DiscreteBandit:
    ...
    if bandit_name == "TS":
        ...
        bandit = UCB1MBandit(n_arms=N_ARMS, arm_values=PRICE_LIST)
    elif bandit_name == "UCBL":
        bandit = UCBLBandit(n_arms=N_ARMS, crp_upper_bound=args.crp_upper_bound, arm_values=PRICE_LIST)
    elif bandit_name == "UCBLM":
        bandit = UCBLMBandit(n_arms=N_ARMS, crp_upper_bound=args.crp_upper_bound, arm_values=PRICE_LIST)
